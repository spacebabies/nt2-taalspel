...
var startWords = ['doen', 'pakken', 'maken', 'eten', 'slapen', 'lezen', 'studeren', 'gebruiken',  
                ...
                'verdienen', 'vluchten', 'vertrouwen', 'verhuizen', 'voelen', 'wonen', 
                'wachten', 'werken', 'zetten', 'leren', 'denken', 'geven', 'gaan', 'helpen',
                'hebben', 'houden', 'kiezen', 'komen', 'krijgen', 'kunnen', 'kijken', 'liggen',
                'spreken', 'vergeten', 'vinden', 'weten', 'worden', 'zijn', 'zitten', 'begrijpen']
...
var relapWords = ['de man', 'het boek', 'de docent', 'het huis', 'het land', 'de jas',
                ...
                'de stad', 'de fiets', 'het kind', 'het verhaal']

var indirectWords = ['vragen of', 'zeggen dat', 'willen weten of', 'geloven dat', 
                    'twijfelen of', 'hopen dat', '(niet) weten of']
